...
import com.powerbridge.bssp.common.util.json.annotation.JSONField;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        for (FieldInfo fieldInfo : getters) {
            ...
            mw.visitLdcInsn(com.powerbridge.bssp.common.util.json.asm.Type.getType(getDesc(fieldInfo.getDeclaringClass())));
    ...
    private void initNature(Class<?> clazz, MethodVisitor mw, Context context) {
        ...
        mw.visitInsn(DUP);
        mw.visitLdcInsn(com.powerbridge.bssp.common.util.json.asm.Type.getType(getDesc(clazz)));
...

        {
            ...
            if (elementType == String.class) {
                ...
                if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                    mw.visitLdcInsn(com.powerbridge.bssp.common.util.json.asm.Type.getType(getDesc((Class<?>) elementType)));

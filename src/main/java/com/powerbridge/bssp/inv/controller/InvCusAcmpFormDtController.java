 ...
 */
@Controller
@RequestMapping("/inv/invCusAcmpFormDt")
@CrossOrigin
public class InvCusAcmpFormDtController extends BaseController {
	@Autowired
    IInvCusAcmpFormDtService invCusAcmpFormDtService;
    ...
    public AjaxResult showInvCusAcmpFormDtList(String seqNo) {
        ...
        try {
            ...
            Page<InvCusAcmpFormDt> invAcmpFormDtList = invCusAcmpFormDtService.selectByInvCusAcmpList(page,seqNo);

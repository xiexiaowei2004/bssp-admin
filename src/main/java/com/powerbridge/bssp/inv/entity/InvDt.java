...
public class InvDt implements Serializable{
	 ...
	 */
	@TableField(exist = false)
	private String gdsSeqnoStart;

	/**
	 * 商品序号止
	 */
	@TableField(exist = false)
	private String gdsSeqnoEnd;
	 ...
	 * 关联出入库单单据编号
	 */
	@TableField("SAS_SEQ_NO")
	private String sasSeqNo;

	public String getSasSeqNo() {
		return sasSeqNo;
	}

	public void setSasSeqNo(String sasSeqNo) {
		this.sasSeqNo = sasSeqNo;
	}
	...
	public String getGdsSeqnoStart() {
		return gdsSeqnoStart;
	}

	public void setGdsSeqnoStart(String gdsSeqnoStart) {
		this.gdsSeqnoStart = gdsSeqnoStart;
	}

	public String getGdsSeqnoEnd() {
		return gdsSeqnoEnd;
	}

	public void setGdsSeqnoEnd(String gdsSeqnoEnd) {
		this.gdsSeqnoEnd = gdsSeqnoEnd;
	}
}

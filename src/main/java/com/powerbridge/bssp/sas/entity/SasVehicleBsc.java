...
public class SasVehicleBsc implements Serializable {
    ...
    @TableField(value = "VEHICLE_WT",validate = FieldStrategy.IGNORED)
    ...
    public String getVehicleTypeNm() {
        return vehicleTypeNm;
    }

    public void setVehicleTypeNm(String vehicleTypeNm) {
        this.vehicleTypeNm = vehicleTypeNm;
    }

...
public class SasDclCusBsc implements Serializable {
	...
	public String getDclTypecdParam() {
		return dclTypecdParam;
	}

	public void setDclTypecdParam(String dclTypecdParam) {
		this.dclTypecdParam = dclTypecdParam;
	}
}

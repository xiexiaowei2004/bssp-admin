...
@TableName("cod_cus_busitype")
public class CodCusBusitype implements Serializable {
	
	@TableField(exist = false)
	private static final long serialVersionUID = -2424406813808569693L;


	@TableId(value = "BUSI_CODE")
	private String busiCode;//代码
   
	@TableField(value = "BUSI_NAME")
    private String busiName;//交工类型
